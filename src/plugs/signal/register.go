...
func RegisterKnownSignals() {
	// REST events
	//RegisterSignalClass("NopEvent", &NopEvent{})
	...
	/*
		...
		RegisterSignalClass("JavaFunctionEvent", &JavaFunctionEvent{})
	*/

	// Actions
	//RegisterSignalClass("NopAction", &NopAction{})
	RegisterSignalClass("EventAcceptanceAction", &EventAcceptanceAction{})
